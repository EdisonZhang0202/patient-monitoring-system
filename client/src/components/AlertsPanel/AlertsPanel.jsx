...
function AlertsPanel({
  ...
  const sortedAlertGroups = Object.entries(alertsByPatient)
    .map(([patientId, group]) => {
      const sortedAlerts = sortAlertsBySeverity(group.alerts);
      const highestSeverity = sortedAlerts[0]?.severity || "low";
  ...
  return (
    <aside className="alerts-panel">
      ...
      <div className="active-alert-list">
        ...
        {sortedAlertGroups.map((group) => (
          <div className="patient-alert-group" key={group.patientId}>
            <div
